...
/**
 * AuthForm Component
 * Combined Login & Signup Auth Form with interactive password toggle, 
 * OAuth social logins, and mode switching.
 */
export const AuthForm = ({
  ...
  return (
    <div className={`auth-form-card ${className}`}>
      ...
      <form className="flex flex-col gap-3.5" onSubmit={handleSubmit}>
        ...
        <div className="inputForm">
          ...
          <input
            ...
            required
          />
          {/* Interactive Password Eye Toggle */}
          <button
            type="button"
          ...
          >
            {showPassword ? (
              ...
              // Eye Icon
              <svg viewBox="0 0 576 512" height="18" width="18" fill="currentColor">
      ...
      <p className="p-text">
        ...
        <button type="button" className="span-link" onClick={toggleMode}>
          {isSignUp ? 'Sign In' : 'Sign Up'}
        </button>
      </p>

      {/* Divider */}
      <div className="line-divider">Or With</div>
      ...
      <div className="oauth-group">
        ...
        <button
          ...
          onClick={onAppleAuth}
        >
          <svg height={20} width={20} viewBox="0 0 22.773 22.773" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            <g>
