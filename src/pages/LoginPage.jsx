...
export const LoginPage = () => {
  ...
  const [email, setEmail] = useState('you@skillseed.com');
  const [password, setPassword] = useState('password123');
  const [selectedRole, setSelectedRole] = useState('student');

  const handleDemoFill = (roleId) => {
    setSelectedRole(roleId);
    if (roleId === 'student') setEmail('you@skillseed.com');
    if (roleId === 'parent') setEmail('parent@skillseed.com');
    if (roleId === 'teacher') setEmail('teacher@skillseed.com');
